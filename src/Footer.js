...
function Footer() {
    return (
        <footer>
            ...
            {new Date().getHours() >= 12 ? <p className="p3">Good afternoon</p> : <p className="p3">Good morning</p>}
            {new Date().getHours() >= 18 ? <p className="p3">Good evening</p> : null}
            {new Date().getHours() >= 22 ? <p className="p3">Good night</p> : null}
